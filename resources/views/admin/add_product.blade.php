...
<body >
    ...
    <div class="uk-container" style="display:flex">
		...
		<div class="uk-width-1-2" style="width:45%; padding-left:80px">
			<div  class='uk-width-1-1@s'>
				<h2 class="uk-text-center">Main image</h2>
				<div id="media-uploader1" style="max-width: 400px; height: 100px;" name="media-uploader1" class="" >
					<div id="dvPrevie" class="dz-messag" style="color:'.get_option('taxCrt-setting-font').';">
						your image
					</div>
				</div>
				<input type="file" name="thumbimg" id="fileupload" >
			</div>
			<div  class='uk-width-1-1@s'>
				<h2 class="uk-text-center">Galery Images</h2>
				<div id="media-uploader1" style="max-width: 400px; height: 100px;" name="media-uploader1" class="">
					<div id="dvPreview" class="dz-message" style="color:'.get_option('taxCrt-setting-font').';">
						your image
					</div>
				</div>
				<input type="file" id="fileuploa" name="upload[]"  multiple>
				
			</div>
		</div>
		<div class="uk-width-1-2" style="width:45%">
			<div class='uk-width-1-1@s'>
				<h2 class="uk-text-center">Product Details</h2>
				<hr />
				<div  id="ttt" class="uk-width-1-1@s">
					<label class="uk-form-label" for="txtModel">Model</label>
					<div class="uk-form-controls">
						<input class="uk-input" name="model" id="txtModel" type="text" placeholder="P40 Warhawk">
					</div>
				</div>
				<div  id="ttt" class="uk-margin">
					<label class="uk-form-label" for="txtBrand">Brand</label>
					<div class="uk-form-controls">
						<input class="uk-input" name="brand" id="txtBrand" type="text" placeholder="Curtiss">
					</div>
				</div>
				<div id="ttt" class="uk-margin">
					<label class="uk-form-label" for="txtPrice">product_name</label>
					<div class="uk-form-controls">
						<input class="uk-input" name="product_name" id="txtPrice" type="text" placeholder="XYZ">
					</div>
				</div>
				<div id="ttt" class="uk-margin">
					<label class="uk-form-label" for="txtPrice">product_categray</label>
					<div class="uk-form-controls">
						<select  class="uk-input" name="product_categray" id="">
				...
				<div id="ttt" class="uk-margin">
					...
					<div class="uk-form-controls">
						<input class="uk-input" name="price" id="txtPrice" type="text" placeholder="2,000,000">
					</div>
				</div>
				<div id="ttt" class="uk-margin">
					<label class="uk-form-label" for="txtPrice">MRP</label>
					<div class="uk-form-controls">
						<input class="uk-input" name="mrp" id="txtPrice" type="text" placeholder="2,000,000">
					</div>
				</div>
				...
				<div id="ttt" class="uk-margin">
					...
					<div class="uk-form-controls">
						<textarea class="uk-textarea" name="description" id="txtDescription"></textarea>
					</div>
				</div>
    ...
    <center>
        <button style="height:40px; width:50%; background-color:green; color:white; margin:40px">submit</button>
    </center>
</form>
</div>
</body>
